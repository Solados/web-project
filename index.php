      ...
      <div class="container">
        <div class="features-grid">
          <article class="feature-card sr-hidden">
            ...
            <p>Wide-ranging question bank covering language, customs, and regional facts.</p>
          </article>
          <article class="feature-card sr-hidden">
            <div class="icon-box"><div class="icon">🧩</div></div>
            <h3>Interactive quizzes</h3>
            <p>Engaging quizzes with selectable lengths and difficulty to match your goals.</p>
          </article>
          <article class="feature-card sr-hidden">
            <div class="icon-box"><div class="icon">📊</div></div>
