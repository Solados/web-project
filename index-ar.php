...
<head>
    ...
    <title>هوية | الصفحة الرئيسية</title>
    ...
    <section class="section video-section">
      <div class="video-wrap">
        ...
        <div class="video-overlay">
          <h1 class="video-welcome" id="video-welcome-ar">مرحباً بكم بمنصة هوّية</h1>
        </div>
      ...
      <div class="container">
        <div class="features-grid">
          ...
          <article class="feature-card sr-hidden">
            ...
            <p>اختبارات مرنة بعدد أسئلة قابل للاختيار وبإمكانية تخصيص نوع وفئات الاسئلة.</p>
          </article>
          <article class="feature-card sr-hidden">
            <div class="icon-box"><div class="icon">📊</div></div>
